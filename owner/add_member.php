<?php 
include('../header.php');
include(ROOT_PATH.'language/'.$lang_code_global.'/lang_add_member.php');
    ...
    <div class="box box-info">
      ...
      <form onSubmit="return validateMe();" action="<?php echo $form_url; ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group col-md-4 col-xs-12">
            ...
            <select onchange="getActiveUnit(this.value)" name="countryId" id="countryId" class="form-control">
          ...
          <div class="form-group col-md-4 col-xs-12">
            ...
            <select name="state" id="ddlUnitNo" onchange="getOwnerInfo(this.value);" class="form-control">
              <option value="">--<?php echo $_data['add_new_form_field_text_4'];?>--</option>
              <?php 
				  	$result_unit = mysql_query("SELECT * FROM tbl_add_unit where floor_no = '".(int)$floor_no."' order by uid ASC",$link);
          ...
          <div class="form-group col-md-4 col-xs-12">
            ...
            <div class="input-group">
              ...
              <input type="text" readonly name="txtTotalRent" value="<?php echo $total_rent;?>" id="txtTotalRent" class="form-control" />
              <div class="input-group-addon"> <?php echo CURRENCY;?> </div>
            </div>
          </div>
          <div class="form-group col-md-4 col-xs-12">
		  ...
		  <div class="row">
           <div class="form-group col-md-4 col-xs-12">
            <label for="txtIssueDate"><?php echo $_data['add_new_form_field_text_16'];?> :</label>
            <input type="text" name="txtIssueDate" value="<?php echo $issue_date;?>" id="txtIssueDate" class="form-control datepicker"/>
          </div>
          <div class="form-group col-md-4 col-xs-12">
            <label for="txtIssueDate"><?php echo $_data['add_new_form_field_text_17'];?> :</label>
            <input type="text" name="txtIssueDate" value="<?php echo $issue_date;?>" id="txtIssueDate" class="form-control datepicker"/>
          </div>
          <div class="form-group col-md-4 col-xs-12">
            <label for="txtIssueDate"><?php echo $_data['add_new_form_field_text_18'];?> :</label>
            <input type="text" name="txtIssueDate" value="<?php echo $issue_date;?>" id="txtIssueDate" class="form-control datepicker"/>
          </div>
          </div>
		  <div class="row">
          <div class="form-group col-md-4 col-xs-12">
            <label for="txtIssueDate"><?php echo $_data['add_new_form_field_text_19'];?> :</label>
            <input type="text" name="txtIssueDate" value="<?php echo $issue_date;?>" id="txtIssueDate" class="form-control datepicker"/>
          </div>
          <div class="form-group col-md-4 col-xs-12">
            <label for="txtIssueDate"><?php echo $_data['add_new_form_field_text_20'];?> :</label>
            <input type="text" name="txtIssueDate" value="<?php echo $issue_date;?>" id="txtIssueDate" class="form-control datepicker"/>
          </div>
          <div class="form-group col-md-4 col-xs-12">
            <label for="txtIssueDate"><?php echo $_data['add_new_form_field_text_21'];?> :</label>
            <input type="text" name="txtIssueDate" value="<?php echo $issue_date;?>" id="txtIssueDate" class="form-control datepicker"/>
          </div>
          </div>
		  ...
		  <div class="row">
          <div class="form-group col-md-4 col-xs-12">
            <label for="txtIssueDate"><?php echo $_data['add_new_form_field_text_22'];?> :</label>
            <input type="text" name="txtIssueDate" value="<?php echo $issue_date;?>" id="txtIssueDate" class="form-control datepicker"/>
          </div>
          <div class="form-group col-md-4 col-xs-12">
            <label for="txtIssueDate"><?php echo $_data['add_new_form_field_text_23'];?> :</label>
            <input type="text" name="txtIssueDate" value="<?php echo $issue_date;?>" id="txtIssueDate" class="form-control datepicker"/>
          </div>
          <div class="form-group col-md-4 col-xs-12">
            <label for="txtIssueDate"><?php echo $_data['add_new_form_field_text_24'];?> :</label>
            <input type="text" name="txtIssueDate" value="<?php echo $issue_date;?>" id="txtIssueDate" class="form-control datepicker"/>
          </div>
          </div>
