...
if(isset($_GET['id']) && $_GET['id'] != '' && $_GET['id'] > 0){
	$sqlx= "DELETE FROM `tbl_add_owner` WHERE memberId = ".$_GET['id'];
        ...
        <table class="table sakotable table-bordered table-striped dt-responsive">
          <thead>
            <tr>
              ...
              <th>Middle Name</th>
              <th>Last Name</th>
              <th><?php echo $_data['society_name'];?></th>
              
              <th><?php echo $_data['profession_name'];?></th>
              <th><?php echo $_data['speciality_profession'];?></th>
              <th><?php echo $_data['vehicle_id'];?></th>
             <th>Gender</th>
             <th>Age</th>
          ...
          <tbody>
            <?php
				$result = mysql_query("Select * from tbl_add_owner where branch_id = " . (int)$_SESSION['objLogin']['branch_id'] . " order by memberId desc",$link);
            ...
            <tr>
              ...
              <td><?php echo $row['societyId']; ?></td>
				...
				<td><?php echo $row['specialityProfession'];?></td>
              ...
              <td><a class="btn btn-success" data-toggle="tooltip" href="javascript:;" onClick="$('#nurse_view_<?php echo $row['memberId']; ?>').modal('show');" data-original-title="<?php echo $_data['view_text'];?>"><i class="fa fa-eye"></i></a> <a class="btn btn-primary" data-toggle="tooltip" href="<?php echo WEB_URL;?>owner/addowner.php?id=<?php echo $row['memberId']; ?>" data-original-title="<?php echo $_data['edit_text'];?>"><i class="fa fa-pencil"></i></a> <a class="btn btn-danger" data-toggle="tooltip" onClick="deleteOwner(<?php echo $row['memberId']; ?>);" href="javascript:;" data-original-title="<?php echo $_data['delete_text'];?>"><i class="fa fa-trash-o"></i></a>
