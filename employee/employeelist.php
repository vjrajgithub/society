    ...
    <div class="box box-info">
      ...
      <div class="box-body">
        <table class="table sakotable table-bordered table-striped dt-responsive">
          ...
          <tbody>
            <?php
                                 $queryAllEmployee = "SELECT *,mt.ed_name FROM tbl_add_employee e inner join tbl_empdesignation mt where mt.ed_id = e.designationId and e.branch_id = " . (int)$_SESSION['objLogin']['branch_id'] . "";
				//die;
