...
?>
<?php
include(ROOT_PATH.'language/'.$lang_code_global.'/lang_admin_list.php');
$delinfo = 'none';
$addinfo = 'none';
$msg = "";
if(isset($_GET['id']) && $_GET['id'] != '' && $_GET['id'] > 0){
	$sqlx= "DELETE FROM `tbl_masteradmin` WHERE adminId = ".$_GET['id'];
...
<div class="row">
  <div class="col-xs-12">
    ...
    <div id="you" class="alert alert-success alert-dismissable" style="display:<?php echo $addinfo; ?>">
      ...
      <?php echo $msg; ?> </div>
    <div align="right" style="margin-bottom:1%;"> <a class="btn btn-primary" data-toggle="tooltip" href="<?php echo WEB_URL; ?>admin/addadmin.php" data-original-title="<?php echo $_data['add_new_employee_breadcam'];?>"><i class="fa fa-plus"></i></a> <a class="btn btn-primary" data-toggle="tooltip" href="<?php echo WEB_URL; ?>dashboard.php" data-original-title="<?php echo $_data['home_breadcam'];?>"><i class="fa fa-dashboard"></i></a> </div>
...
<!--              <th><?php echo $_data['imgage'];?></th>-->
          ...
          <tbody>
            <?php
                                $queryAllEmployee = "SELECT *  FROM tbl_masteradmin ";
				//die;
...
<!--              <td><img class="photo_img_round" style="width:50px;height:50px;" src="<?php echo $image;  ?>" /></td>-->
              ...
              <td><a class="btn btn-success" data-toggle="tooltip" href="javascript:;" onClick="$('#nurse_view_<?php echo $row['adminId']; ?>').modal('show');" data-original-title="<?php echo $_data['view_text'];?>"><i class="fa fa-eye"></i></a> <a class="btn btn-primary" data-toggle="tooltip" href="<?php echo WEB_URL;?>admin/addadmin.php?id=<?php echo $row['adminId']; ?>" data-original-title="<?php echo $_data['edit_text'];?>"><i class="fa fa-pencil"></i></a> <a class="btn btn-danger" data-toggle="tooltip" onClick="deleteEmployee(<?php echo $row['adminId']; ?>);" href="javascript:;" data-original-title="<?php echo $_data['delete_text'];?>"><i class="fa fa-trash-o"></i></a>
                <div id="nurse_view_<?php echo $row['adminId']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<!--                        <div><img class="photo_img_round" style="width:100px;height:100px;" src="<?php echo $image;  ?>" /></div>-->
                        <div class="model_title"><?php //echo $row['adminName']; ?></div>
                      </div>
                      <div class="modal-body">
                        <h3 style="text-decoration:underline;"><?php echo $_data['details_information'];?></h3>
                        <div class="row">
                          <div class="col-xs-12"> <b><?php echo $_data['add_new_form_field_text_1'];?> :</b> <?php echo $row['adminName']; ?><br/>
                            <b><?php echo $_data['add_new_form_field_text_2'];?> :</b> <?php echo $row['adminEmail']; ?><br/>
                            <b><?php echo $_data['add_new_form_field_text_3'];?> :</b> <?php echo $row['password']; ?><br/>
                            <b><?php echo $_data['add_new_form_field_text_4'];?> :</b> <?php echo $row['contactNumber']; ?><br/>
<!--                            <b><?php echo $_data['add_new_form_field_text_5'];?> :</b> <?php echo $row['e_pre_address']; ?><br/>
                            ...
                            <b><?php echo $_data['add_new_form_field_text_9'];?> :</b> <?php echo $row['updateDate']; ?><br/>
                          </div>
                        </div>
                      </div>
                    </div>
...
function deleteEmployee(Id){
	...
	if(iAnswer){
		window.location = '<?php echo WEB_URL; ?>admin/adminlist.php?id=' + Id;
	}
  }
