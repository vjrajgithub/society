  ...
  <div class="col-md-12">
	...
	<div class="row">
          <div class="form-group col-md-6 col-xs-12">
            <label for="ddlFloor"><span class="errorStar">*</span><?php echo 'Block';?> :</label>
          ...
          <div class="form-group col-md-6 col-xs-12">
            ...
            <div class="form-group col-md-6 col-xs-12">
            <label for="ddlFloor"><span class="errorStar">*</span><?php echo 'Flat Type';?> :</label>
            <select name="ddlFloor" id="ddlFloor" class="form-control">
              <option value="">--<?php echo 'Select Flat Type';?>--</option>
              <?php 
				  	$result_floor = mysql_query("SELECT distinict * FROM flat_type_master group by flatType order by flatType ASC",$link);
					while($row_floor = mysql_fetch_array($result_floor)){?>
              <option <?php if($floor_no == $row_floor['fid']){echo 'selected';}?> value="<?php echo $row_floor['fid'];?>"><?php echo $row_floor['floor_no'];?></option>
              <?php } //mysql_close($link); ?>
            </select>
