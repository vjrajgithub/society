...
if(isset($_POST['txtName'])){
	...
	$month = date('m');
	$year = date('Y');
	echo $sql = "INSERT INTO `tbl_visitor`(issue_date,name,mobile,address,floor_id,unit_id,vehicleNo,no_of_visiters,intime,outtime,xmonth,xyear,branch_id) values('$_POST[txtIssueDate]','$_POST[txtName]','$_POST[txtMobile]','$_POST[txtAddress]','$_POST[ddlFloorNo]','$_POST[ddlUnitNo]','$_POST[txtVehicle]','$_POST[txtNoOfVisiter]','$_POST[txtInTime]','$_POST[txtOutTime]',$month,$year,'" . $_SESSION['objLogin']['branch_id'] . "')";
	...
	$sql = "UPDATE `tbl_visitor` SET  `vehicleNo`='".$_POST['txtVehicle']."',`no_of_visiters`='".$_POST['txtNoOfVisiter']."',`issue_date`='".$_POST['txtIssueDate']."',`name`='".$_POST['txtName']."',`mobile`='".$_POST['txtMobile']."',`address`='".$_POST['txtAddress']."',`floor_id`='".$_POST['ddlFloorNo']."',`unit_id`='".$_POST['ddlUnitNo']."',`intime`='".$_POST['txtInTime']."',`outtime`='".$_POST['txtOutTime']."' WHERE vid='".$_GET['id']."'";
	mysql_query($sql,$link);
...
if(isset($_GET['id']) && $_GET['id'] != ''){
	...
	while($row = mysql_fetch_assoc($result)){
		...
		$mobile = $row['mobile'];
                ...
                $noOfVisister = $row['no_of_visiters'];
		...
		<div class="row">
          ...
          <div class="form-group col-md-4 col-xs-12">
		   ...
		   <div class="row">
            ...
            <label for="txtFloor"><?php echo $_data['text_19'];?> :</label>
            <input type="text" name="txtVehicle" value="<?php echo $vehicle;?>" id="txtVehicle" class="form-control" />
          </div>
            <div class="form-group col-md-6 col-xs-12">
            <label for="txtFloor"><?php echo $_data['text_20'];?> :</label>
            <input type="text" name="txtNoOfVisiter" value="<?php echo $noOfVisister;?>" id="txtNoOfVisiter" class="form-control" />
          </div>
          </div>
		  <div class="row">
