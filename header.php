        ...
        <li class="dropdown user user-menu"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="fa fa-user fa-lg"></i> <span class="hidden-xs"> <?php echo $_SESSION['objLogin']['name']; ?> </span> </a>
          <ul class="dropdown-menu">
            ...
            <li class="user-header"> <img src="<?php echo WEB_URL; ?>assets/img/user.png" class="img-circle" alt="User Image" />
			  ...
			  <small>
                <?php if($_SESSION['login_type'] == '1'){echo 'Admin';} else if($_SESSION['login_type'] == '2'){echo 'Owner';} else if($_SESSION['login_type'] == '3'){echo '
                ...
                ';} else if($_SESSION['login_type'] == '4'){echo 'Employee';} else {echo 'Super Admin';}?>
...
<aside class="main-sidebar">
  ...
  <section class="sidebar" style="margin-top:10px;">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview <?php if($page_name != '' && $page_name == 'addunit' || $page_name == 'unitlist'||$page_name=='blockno'){echo 'active';}?>"> <a href="#"> <i class="fa fa-empire"></i> <span><?php echo $_data['menu_unit_information']; ?></span> <i class="fa fa-angle-left pull-right"></i> </a>
        <ul class="treeview-menu">
               <li class="<?php if($page_name != '' && $page_name == 'unit_setup'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>setting/unit_setup.php"><i class="fa fa-arrow-circle-right"></i><?php echo $_data['menu_unit_setup'];?></a></li>
                <li class="<?php if($page_name != '' && $page_name == 'addblock'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>unit/addblock.php"><i class="fa fa-arrow-circle-right"></i><?php echo $_data['menu_add_block']; ?></a></li>
        </ul>
      </li>
      <li class="treeview <?php if($page_name != '' && $page_name == 'addowner' || $page_name == 'ownerlist' || $page_name=='addmember'){echo 'active';}?>"> <a href="#"> <i class="fa fa-user"></i> <span><?php echo $_data['menu_owner_information']; ?></span> <i class="fa fa-angle-left pull-right"></i> </a>
        ...
        <li class="<?php if($page_name != '' && $page_name == 'addmember'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>owner/add_member.php"><i class="fa fa-arrow-circle-right"></i><?php echo $_data['menu_add_member']; ?></a></li>
        </ul>
     ...
     <!-----------------Vijay Code 18Apr Start -------------> 
      
      <li class="treeview <?php if($page_name != '' && $page_name == 'addadmin' || $page_name == 'adminlist'){echo 'active';}?>"> <a href="#"> <i class="fa fa-user"></i> <span><?php echo $_data['menu_admin_information']; ?></span> <i class="fa fa-angle-left pull-right"></i> </a>
        <ul class="treeview-menu">
          <li class="<?php if($page_name != '' && $page_name == 'adminlist'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>admin/adminlist.php"><i class="fa fa-arrow-circle-right"></i><?php echo $_data['menu_admin_list']; ?></a></li>
		  <li class="<?php if($page_name != '' && $page_name == 'addadmin'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>admin/addadmin.php"><i class="fa fa-arrow-circle-right"></i><?php echo $_data['menu_add_admin']; ?></a></li>
        </ul>
      </li>
	  
	  
	  <li class="treeview <?php if($page_name != '' && $page_name == 'addserviceprovider' || $page_name == 'addserviceproviderlist'){echo 'active';}?>"> <a href="#"> <i class="fa fa-user"></i> <span><?php echo $_data['menu_addserviceprovider_information']; ?></span> <i class="fa fa-angle-left pull-right"></i> </a>
        <ul class="treeview-menu">
          <li class="<?php if($page_name != '' && $page_name == 'addserviceproviderlist'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>service/addserviceproviderlist.php"><i class="fa fa-arrow-circle-right"></i><?php echo $_data['menu_addserviceprovider_list']; ?></a></li>
		  <li class="<?php if($page_name != '' && $page_name == 'addserviceprovider'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>service/addserviceprovider.php"><i class="fa fa-arrow-circle-right"></i><?php echo $_data['menu_add_serviceprovider']; ?></a></li>
        </ul>
      </li>
	  ...
	  <li class="<?php if($page_name != '' && $page_name == 'facility_setup'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>setting/facility_setup.php"><i class="fa fa-arrow-circle-right"></i><?php echo $_data['menu_facility_setup'];?></a></li>
      ...
      <li class="<?php if($page_name != '' && $page_name == 'building_info'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>building/buildinglist.php"><i class="fa fa-building"></i> <span><?php echo $_data['menu_building_list'];?></span></a> </li>
      <li class="treeview <?php if($page_name != '' && $page_name == 'addcomplain' || $page_name == 'complainlist'){echo 'active';}?>"> <a href="#"> <i class="fa fa-warning"></i> <span><?php echo $_data['menu_complain'];?></span> <i class="fa fa-angle-left pull-right"></i> </a>
        <ul class="treeview-menu">
          <li class="<?php if($page_name != '' && $page_name == 'complainlist'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>complain/complainlist.php"><i class="fa fa-arrow-circle-right"></i><?php echo $_data['menu_complain_list'];?></a></li>
		  <li class="<?php if($page_name != '' && $page_name == 'addcomplain'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>complain/addcomplain.php"><i class="fa fa-arrow-circle-right"></i><?php echo $_data['menu_add_complain'];?></a></li>
        </ul>
      </li>	  	  	  <li class="treeview <?php if($page_name != '' && $page_name == 'addannaunce' || $page_name == 'annauncelist'){echo 'active';}?>"> <a href="#"> <i class="fa fa-user"></i> <span><?php echo $_data['menu_annaunce_information']; ?></span> <i class="fa fa-angle-left pull-right"></i> </a>        <ul class="treeview-menu">          <li class="<?php if($page_name != '' && $page_name == 'accauncelist'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>annaunce/annauncelist.php"><i class="fa fa-arrow-circle-right"></i><?php echo $_data['menu_annaunce_list']; ?></a></li>		  <li class="<?php if($page_name != '' && $page_name == 'addaccaunce'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>annaunce/addannaunce.php"><i class="fa fa-arrow-circle-right"></i><?php echo $_data['menu_add_annaunce']; ?></a></li>        </ul>      </li>      <li class="treeview <?php if($page_name != '' && $page_name == 'addevent' || $page_name == 'eventlist'){echo 'active';}?>"> <a href="#"> <i class="fa fa-user"></i> <span><?php echo $_data['menu_event_information']; ?></span> <i class="fa fa-angle-left pull-right"></i> </a>        <ul class="treeview-menu">          <li class="<?php if($page_name != '' && $page_name == 'eventlist'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>event/eventlist.php"><i class="fa fa-arrow-circle-right"></i><?php echo $_data['menu_event_list']; ?></a></li>		  <li class="<?php if($page_name != '' && $page_name == 'addevent'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>event/addevent.php"><i class="fa fa-arrow-circle-right"></i><?php echo $_data['menu_add_event']; ?></a></li>        </ul>      </li>
      ...
      <li class="treeview <?php if($page_name != '' && $page_name == 'bill_setup' || $page_name != '' && $page_name == 'utility_bill_setup' || $page_name == 'employee_salary_setup' || $page_name == 'member_type_setup' || $page_name == 'month_setup' || $page_name == 'year_setup' || $page_name == 'language' || $page_name == 'admin'){echo 'active';}?>"> <a href="#"> <i class="fa fa-gear"></i> <span><?php echo $_data['menu_settings'];?></span> <i class="fa fa-angle-left pull-right"></i> </a>
        ...
        <li class="<?php if($page_name != '' && $page_name == 'bill_setup'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>setting/bill_setup.php"><i class="fa fa-arrow-circle-right"></i><?php echo $_data['menu_bill_setup'];?></a></li>
		  ...
		  <li class="<?php if($page_name != '' && $page_name == 'flat_type_setting'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>setting/flat_type_setting.php"><i class="fa fa-arrow-circle-right"></i><?php echo $_data['menu_flat_setting'];?></a></li>
		  <li class="<?php if($page_name != '' && $page_name == 'facility_setting'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>setting/facility_setting.php"><i class="fa fa-arrow-circle-right"></i><?php echo $_data['menu_facility_setting'];?></a></li>
	  <li class="<?php if($page_name != '' && $page_name == 'facility_setting'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>setting/facility_setting.php"><i class="fa fa-arrow-circle-right"></i><?php echo $_data['menu_facility_setting'];?></a></li>
            <li class="<?php if($page_name != '' && $page_name == 'emp_desig_setting'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>setting/emp_desig_setting.php"><i class="fa fa-arrow-circle-right"></i><?php echo $_data['menu_emp_desig_setting'];?></a></li>
            <li class="<?php if($page_name != '' && $page_name == 'service_setup'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>setting/service_setup.php"><i class="fa fa-arrow-circle-right"></i><?php echo $_data['menu_service_setup'];?></a></li>
	   <li class="<?php if($page_name != '' && $page_name == 'employee_salary_setup'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>setting/employee_salary_setup.php"><i class="fa fa-arrow-circle-right"></i><?php echo $_data['menu_employee_setup'];?></a></li>
            <li class="<?php if($page_name != '' && $page_name == 'member_type_setup'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>setting/member_type_setup.php"><i class="fa fa-arrow-circle-right"></i><?php echo $_data['menu_management_member_type'];?></a></li>
