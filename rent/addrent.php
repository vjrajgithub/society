        ...
        <div class="box-body">
          ...
          <div class="form-group col-md-4 col-xs-12">
            ...
            <select name="ddlUnitNo" id="ddlUnitNo" class="form-control">
              ...
              <?php 
				  	$result_unit = mysql_query("SELECT * FROM tbl_add_unit where floor_no = ".(int)$r_floor_no." order by unit_no ASC",$link);
          ...
          <div class="form-group col-md-4 col-xs-12">
              ...
              <select name="ddlMonth" id="ddlMonth" class="form-control">
                ...
                <?php 
				  	$result_unit = mysql_query("SELECT * FROM tbl_add_month_setup order by m_id ASC",$link);
					while($row_unit = mysql_fetch_array($result_unit)){?>
            ...
            <div class="form-group col-md-4 col-xs-12">
              ...
              <select name="ddlYear" id="ddlYear" class="form-control">
                ...
                <?php 
				  	$result_unit = mysql_query("SELECT * FROM tbl_add_year_setup order by y_id ASC",$link);
					while($row_unit = mysql_fetch_array($result_unit)){?>
          ...
          <div class="form-group"> <span class="btn btn-file btn btn-primary"><?php echo $_data['upload_image'];?>
           ...
           <input type="submit" name="submit" class="btn btn-primary pull-right" value="<?php echo $button_text; ?>"/>
			</div>
        </div>
